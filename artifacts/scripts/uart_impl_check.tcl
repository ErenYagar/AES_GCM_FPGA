...
place_design
route_design
report_timing_summary -file {C:/project/FPGA/uart_impl_timing.rpt}
report_drc -file {C:/project/FPGA/uart_impl_drc.rpt}
report_utilization -file {C:/project/FPGA/uart_impl_utilization.rpt}
exit
