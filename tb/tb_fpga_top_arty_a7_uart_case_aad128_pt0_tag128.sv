...
module tb_fpga_top_arty_a7_uart_case_aad128_pt0_tag128;
    ...
    localparam [255:0] KEY_VEC =
        256'h4d01c96ef9d98d4fb4e9b61be5efa772c9788545b3eac39eb1cacb997a5f0792;
    localparam [95:0] IV_VEC =
        96'h32124a4d9e576aea2589f238;
    localparam [127:0] AAD_VEC =
        128'hd72bad0c38495eda50d55811945ee205;
    localparam [127:0] TAG_EXP =
        128'h6d6397c9e2030f5b8053bfe510f3f2cf;
    ...
    initial begin
        ...
        for (i = 0; i < 16; i = i + 1) begin
            ...
            if (payload_byte !== get_buffer_byte_128(TAG_EXP, 16, i))
                $fatal(1, "TAG byte mismatch at %0d got=%02h expected=%02h", i, payload_byte, get_buffer_byte_128(TAG_EXP, 16, i));
        end
