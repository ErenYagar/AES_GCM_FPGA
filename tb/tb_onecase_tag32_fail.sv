...
initial begin
    ...
    send1024(3'd5,{896'd0,TAG_EXP},TAG_BITS);
    while(wait_cycles<40000) begin
        ...
        if((ct_seen==13) && (tag_seen==4)) begin
            $display("One-case tag32 fail vector completed.");
            #20;
            $finish;
        end
    end
    $fatal(1,"Timeout waiting for one-case tag32 regression.");
end
endmodule
